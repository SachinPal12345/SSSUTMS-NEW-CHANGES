...
<Button
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>Add_Course</Modal.Title>
              </Modal.Header>
              <Modal.Body>
               <Addcourse />
              </Modal.Body>
          ...
          <Button variant="secondary" onClick={handleClose}>
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>Update_Course</Modal.Title>
              </Modal.Header>
              <Modal.Body>
               <Updatecourse />
              </Modal.Body>
                          ...
                          <TableRow hover role="checkbox" tabIndex={-1} key={row.role_id}>
                            ...
                            <TableCell>
                              <div style={{ display: 'flex', gap: '10px' }}>
                                ...
                                <img  onClick={handleShow1} src={edit1} alt="edit" style={{ width: "30px" }} />
                                <img   onClick={() => {
                                    if (
                                      window.confirm(
                                  ...
                                  }}  src={delete1} alt="delete" style={{ width: "30px" }} />
                              </div>
                            </TableCell>
                          </TableRow>
                        ))}
