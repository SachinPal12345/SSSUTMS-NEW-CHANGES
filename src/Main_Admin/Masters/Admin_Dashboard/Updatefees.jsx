...
//                             }}
//                         >
//                             <h5 style={{ padding: "10px", textAlign:"center" }}>Update_Fees</h5>
//                         </div>
...
//           <input type="text" placeholder="Corse Type" required="" />
//         </div>
//         <div className="input-box">
...
//       <button style={{marginLeft:"40%",borderRadius:"10px"}}>Submit</button>
//     </form>
//   </section>
// </>
...
{errors.selectedType && touched.selectedType ? (
  <p className="error">{errors.selectedType}</p>
        ...
        <button style={{marginLeft:"35%",borderRadius:"10px"}}>Submit</button>
      </form>
    </section>
  </>
