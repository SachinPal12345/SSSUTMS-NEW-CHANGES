        ...
        <div className="sidebar close">
          <ul className="nav-links" style={{ marginTop: "30px" }}>
            ...
            <li>
              ...
              <img src="data:image/png;base64,"
                  style={{
                    width: "25px",
                    marginLeft: "25px",
                    marginTop: "15px",
            ...
            <li>
              <a href="#">
                ...
                <img
                  src="data:image/png;base64,"
                  style={{
                    width: "24px",
                    marginLeft: "25px",
                    marginTop: "18px",
...
<Link to = "/admindetails">
            ...
            <a href="#">
                  <img
                  src="data:image/png;base64,"
                    style={{
                      width: "26px",
                      marginLeft: "25px",
                      marginTop: "15px",
            ...
            <li>
              ...
              <ul className="sub-menu" style={{ marginTop: "-380px" }}>
                <li>
                  <a className="link_name" href="#">
                    Accounts
                  </a>
            ...
            <li>
              ...
              <ul className="sub-menu blank" style={{ marginTop: "-180px" }}>
                <li>
                  <a className="link_name" href="#">
                    Examination
                  </a>
            ...
            <li>
              ...
              <ul className="sub-menu blank" style={{ marginTop: "-110px" }}>
                <li>
                  <a className="link_name" href="#">
                    Student
                  </a>
