...
function ErpDashboard() {
  ...
  return (
    <>
      ...
      <div className="shadow p-3 bg-body rounded" style={{ width: "40%", height: "360px", marginLeft: "160px", marginTop: "-22%" }}>
        <div id="chartdiv" style={{ width: "100%", height: "360px" }}></div>
      </div>
      <div className="row2 shadow p-3 bg-body rounded" style={{ margin: "20px", width: "100%", maxWidth: "500px", height: "360px", backgroundColor: "#fff", marginTop: '-26%', marginLeft: '55%' }}>
        <Chart chartType="PieChart" width="100%" height="300px" data={data2} options={options2} />
      </div>
    </>
  );
}
